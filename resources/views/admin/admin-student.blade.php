<x-admin-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-6 bg-gray-900">
        <div class="flex justify-between items-center mb-6">
            <button type="button" class="text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">
                Add Student
            </button>
            <div class="relative">
                <input type="text" 
            ...
            <tbody>
                @foreach ($students as $student)
                    <tr class="border-t border-gray-700 bg-gray-800 hover:bg-gray-700">
                        ...
                        <td class="px-6 py-4">
                            <a href="#" class="text-blue-500 hover:underline">Edit Data</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
